...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> buildRedBlackTree(BTree.Node<T> r) {
        ...
        if (r.getItemCount() == 1) {
            n = new RBTreeNode<T>(true,  r.getItemAt(0),
                    buildRedBlackTree(r.getChildAt(0)), buildRedBlackTree(r.getChildAt(1)));
        } else if (r.getItemCount() == 2) {
            right = new RBTreeNode<T>(false, r.getItemAt(1),
                    buildRedBlackTree(r.getChildAt(1)), buildRedBlackTree(r.getChildAt(2)));
            n = new RBTreeNode<T>(true, r.getItemAt(0), buildRedBlackTree(r.getChildAt(0)), right);
        } else {
            left = new RBTreeNode<T>(false, r.getItemAt(0),
                    buildRedBlackTree(r.getChildAt(0)), buildRedBlackTree(r.getChildAt(1)));
            right = new RBTreeNode<T>(false, r.getItemAt(2),
                    buildRedBlackTree(r.getChildAt(2)), buildRedBlackTree(r.getChildAt(3)));
            n = new RBTreeNode<T>(true, r.getItemAt(1), left, right);
        }
