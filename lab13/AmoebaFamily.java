...
//        }
    ...
    public class AmoebaIterator implements Iterator<Amoeba> {
        ...
        public Amoeba next() {
            ...
            Amoeba curr = fringe.removeFirst();

//            for(int i = curr.children.size()-1; i >= 0; i--){
//                fringe.addLast(curr.children.get(i));
//            }
    ...
    public static class Amoeba {
        ...
        public void print_helper(int s){
            s = s += 4;
            String spaces = String.format("%"+s+"s", "");
        ...
        public String longestName(){
            String maxLengthNameSeen = name;
            for (Amoeba a : children) {
                if ( maxLengthNameSeen.length() < a.longestName().length() ){
                    maxLengthNameSeen = a.longestName();
                }
            }
            return maxLengthNameSeen;
        }
